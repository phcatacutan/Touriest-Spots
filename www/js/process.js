	...
	menu:function(){
		...
		<div className="navbar">
              <div className="navbar-inner">
                <div className="center">TOURIST SPOTS IN THE PHILIPPINES</div>
              </div>
            </div>
			<ul>
				<p><b>LUZON</b></p>
	...
	page2:function(){
			let content = <div>
				<img src='img/banaue.jpg' width='100%' /><a href='#' className='btn-back' onClick={process.menu}><b>Back</b></a>
				 <br/><b>Banaue Rice Terreces >>></b><br/>
...
page9:function(){
	...
	page14:function(){
		let content = <div>
			...
			<br/><b>Maria Cristina Falls >>></b><br/>
